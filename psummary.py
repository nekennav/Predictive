...
# Custom CSS for abstract computer pattern-themed styling
st.markdown(
    """
    <style>
    /* Main app background with abstract computer pattern image */
    .stApp {
        background-image: url('https://w0.peakpx.com/wallpaper/388/301/HD-wallpaper-abstract-computer-patterns-violet-abstract-backgrounds-creative-computer-symbols-artwork.jpg');
